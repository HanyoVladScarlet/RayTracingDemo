...
namespace CsDemo.Primes
{
    ...
    /// 对应章节8-5，图9
    /// </summary>
    internal class LambertMaterialDemo
    {
        public static void RenderImage()
        {
            ...
            OutputUtil.SaveImage("Img09-LambertianSphere.ppm", sb.ToString());
        }
        ...
        private static Vector3 RayColor(Ray ray, IHittable world, int depth)
        {
            ...
            {
                Vector3 target = rec.HitPoint + rec.Normal + MathUtil.GetRandomUnitVector3();
